...
<meta property="og:image" content="${APP_URL}/og-default.png?v=3">
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  header a{color:var(--ink);text-decoration:none;font-weight:800;font-size:20px;display:inline-flex;align-items:center;gap:8px}
  header a img{width:26px;height:26px;border-radius:7px}
...
const FAQS: Array<{ q: string; a: string }> = [
  ...
  { q: "What happens when the ring goes red? Does it shame whoever hasn't been?",
    a: "The ring never names anyone. It only shows how long it's been since anyone visited. It works precisely because nobody is accused — there's just a quiet, shared fact, and someone always responds to it." },
