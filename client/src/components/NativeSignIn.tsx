...
/**
 * Official Apple logo artwork per Apple Design Resources ("Sign in with Apple"
 * button glyph). Required by App Review Guideline 4 — third-party icon sets
 * (e.g. lucide) are not permitted for this button.
 */
function AppleLogo() {
  return (
    <svg
    ...
    <div className="w-full max-w-sm mx-auto flex flex-col gap-4">
      ...
      {screen === "buttons" && (
        <div className="flex flex-col gap-3">
          ...
          {/* HIG-compliant Sign in with Apple button: black fill, official
              Apple logo artwork, system font — per Apple Design Resources. */}
          {currentPlatform !== "android" && (
          <button
            type="button"
            className="w-full h-12 rounded-lg bg-black text-white text-base font-medium flex items-center justify-center gap-2.5 disabled:opacity-60"
